...
namespace Gradeo.CoreApplication.Infrastructure.Migrations
{
    ...
    [Migration("20230205143258_LimitPermissionsAccessOfGradeoAdmin")]
    partial class LimitPermissionsAccessOfGradeoAdmin
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Gradeo.CoreApplication.Domain.Entities.StudyGroupSubject", b =>
                {
                    ...
                    b.HasKey("SubjectId", "StudyGroupId");
            ...
            modelBuilder.Entity("Gradeo.CoreApplication.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("888726f8-5476-4d55-acb6-98bd304e1033"),
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("Gradeo.CoreApplication.Domain.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("888726f8-5476-4d55-acb6-98bd304e1033"),
                            RoleId = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            LastModifiedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0))
                        });
